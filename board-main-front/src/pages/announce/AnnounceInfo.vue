  ...
  <div>
    ...
    <div class="w-full">
      ...
      <div class="flex justify-end">
        ...
        <Button v-if="isOverAdmin()" class="m-2 !px-4 !py-3 !bg-red-400 !border !border-red-400 hover:!bg-red-500 hover:!border hover:!border-red-500" @click="deleteAction">삭제</Button>
      </div>
    </div>
  </div>
</template>
