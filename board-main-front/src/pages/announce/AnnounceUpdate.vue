<template>
  <div>
    ...
    <div class="flex justify-end">
      ...
      <Button class="m-2 !px-4 !py-3 !bg-green-400 !border !border-green-400 hover:!bg-green-500 hover:!border hover:!border-green-500" @click="announceRegist">수정</Button>
    </div>
  </div>
</template>
...
const announceRegistAction = async () => {
  ...
  const reqData = {
    'memberUUID': decryptStringSalt(userStore.getCurrentUser.uud),
